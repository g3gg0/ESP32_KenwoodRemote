...
void ha_publish()
{
    ...
    for (int pos = 0; pos < ha_info.entitiy_count; pos++)
    {
        ...
        ha_addmqtt(json_str, "rgbw_cmd_t", ha_info.entities[pos].rgbw_t);
        ha_addmqtt(json_str, "rgb_cmd_t", ha_info.entities[pos].rgb_t);
        ha_addmqtt(json_str, "fx_cmd_t", ha_info.entities[pos].fx_cmd_t);
        ha_addmqtt(json_str, "fx_stat_t", ha_info.entities[pos].fx_stat_t);
